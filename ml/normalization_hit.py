...
df = pd.read_parquet("../ml/processed_events_1600/all_showers.parquet")
...
numeric_cols = ["kinetic_energy"] + spatial_features + time_features
...
# --- Step 6: Save result ---
normalized_df.to_parquet("../ml/processed_events_1600/normalized_features.parquet", index=False)
